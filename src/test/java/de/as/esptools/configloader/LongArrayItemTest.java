...
public class LongArrayItemTest {
    ...
    public void testTypeExportUnsigned() throws DataImportException {
        try {
            ...
            // Assert.assertEquals("long[4] : 1 0 0 -1", instu.exportTypeAndDataString(false));
            fail("invalid");
        ...
        try {
            ...
            // Assert.assertEquals("long[4] : 1000 1000 1000 -1000", instu.exportTypeAndDataString(false));
            fail("invalid");
        } catch (DataImportException e) {
            // NOP
        }
