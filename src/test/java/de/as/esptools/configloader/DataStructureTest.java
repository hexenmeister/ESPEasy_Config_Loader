...
public class DataStructureTest {
	...
	public void testExportNameAndTypeAndDataString() throws DataImportException, DataItemCreationException {
		...
		Assert.assertEquals("struct TEST_STRUCT {|boolean bool1 : 1|byte byte1 : DE|char char1 : H|"
		...
		// System.out.println(export);
		Assert.assertEquals(
				"struct TEST_STRUCT {|boolean bool1 : 1|byte byte1 : DE|char char1 : H|"
						+ "float float1 : 1.01|int16 int1 : 13330|uint16 int2 : 9096|"
						+ "int8 int3 : 85|uint8 int4 : 145|int int5 : -27902|"
	...
	public void testExportTypeAndDataString() throws DataImportException, DataItemCreationException {
		...
		export = export.replaceAll("\\s+", "");
		// System.out.println(export);
		Assert.assertEquals("structTEST_STRUCT{|boolean:1}|", export);
		...
		// System.out.println(export);
		Assert.assertEquals(
				"structTEST_STRUCT{|boolean:1|byte:DE|char:H|float:1.01|int16:13330|uint16:9096|int8:85|uint8:145|int:-27902|uint:148|long:-2147483648|ulong:4294967295}|",
				export);
		...
		// System.out.println(export);
		Assert.assertEquals(
				"structTEST_STRUCT{|boolean:1|byte:DE|char:H|float:1.01|int16:13330|uint16:9096|int8:85|uint8:145|int:-27902|uint:148|long:-2147483648|ulong:4294967295|fillup:26|byte:FF}|",
				export);
	...
	public void testImportTypeAndDataStringCreate() throws DataImportException, DataItemCreationException {
		...
		export = export.replaceAll("\r+", "");
		export = export.replaceAll("\\s+", " ");
		Assert.assertEquals("struct TEST {|boolean bool1 : 1|byte byte1 : DE|char char1 : H|"
				+ "float float1 : 1.01|int16 int1 : 13330|uint16 int2 : 9096|"
				+ "int8 int3 : 85|uint8 int4 : 145|int int5 : -27902|"
				+ "uint int6 : 148|long long1 : -2147483648|ulong long2 : 4294967295}|", export);
