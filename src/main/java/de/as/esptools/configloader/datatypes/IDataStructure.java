...
public interface IDataStructure {
    ...
    /**
     * Importiert den gegebenen String, überprüft die angegebenen Typen und überführt Daten in seine interne Darstellung.
     * 
     * @param data Eingabe-String
     * @throws DataImportException falls Probleme beim Import afgetreten sind
     */
    public void importTypeAndDataString(String data) throws DataImportException;

    /**
     * Analysiert den gegebenen String, erstellt benötigte Datentypen (fügt Items hinzu) und übernimmt die Daten (Name, Werte) darein.
     * 
     * @param data Eingabe-String
     ...
     * 
     * @param data Strukture mit Daten
     * @throws DataImportException falls Probleme beim Import afgetreten sind
     */
    public void importStructure(IDataStructure data) throws DataImportException;

    /**
     * Füllt die Datenstruktur bis zu der gegebenen Adresse auf. Diese Adresse wird die nächte freie Adresse.
     * 
     * @param toAddress Adresse, bis der aufgefüllt werden muss (also die nächte nach dem Filler)
     */
